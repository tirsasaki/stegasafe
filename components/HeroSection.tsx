  ...
  return (
    <section id="beranda" className="container-page grid items-center gap-10 pb-10 pt-16 lg:grid-cols-[1.1fr_.9fr] lg:pb-14 lg:pt-24">
      <div className="max-w-3xl">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl lg:text-6xl dark:text-white">Sembunyikan Pesan di Dalam Gambar</h1>
        <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600 dark:text-slate-300">Lindungi dan sisipkan pesan rahasia ke dalam gambar PNG. Semua diproses langsung di perangkat Anda.</p>
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <a href="#alat" onClick={() => chooseMode("encode")} className="btn-primary">Mulai Menyembunyikan <ArrowDown className="size-4" /></a>
          <a href="#alat" onClick={() => chooseMode("decode")} className="btn-secondary">Ekstrak Pesan <ArrowRight className="size-4" /></a>
        </div>
